...
function App() {
  ...
  return (
    ...
    <div className="App">
      <Routes>
        <Route path='/login' element={<Login user={user} pass={pass} setUser={setUser} setPass={setPass}/>}/>
        <Route path='/' element={<Home good={good} setGood={setGood} s={s} setSat={setSat} exe={exe} setExe={setExe} Changess={Changess} Changes={Changes} Change={Change}/>}/>
